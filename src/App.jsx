    ...
    <Router>
      <Container>
        ...
        <Switch>
          ...
          <Route path="/MovieLinkPost/:id" component={MovieLinkPost}></Route>
          <Route path="/MovieRatingPost/:id" component={MovieRating}></Route>
          <Route path="/NewGenrePost/:id" component={NewGenrePost}></Route>
